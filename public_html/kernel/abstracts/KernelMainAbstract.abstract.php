...
use kernel\classes\KernelFunctions;
use kernel\classes\KernelScanner;

abstract class KernelMainAbstract {
	
    protected function f() {
    	return new KernelFunctions();
    }
	
    protected function sc($dir = "") {
    	return new KernelScanner($dir);
    }
